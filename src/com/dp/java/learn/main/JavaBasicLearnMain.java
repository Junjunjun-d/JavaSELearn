package com.dp.java.learn.main;

import com.dp.java.learn.sub.exercise.LilyNumber;

/**
 * 一个源文件中可以有多个类（class）但是只能有一个公开类（pubic calss）
 * 并且公开类的类名必须和源文件名称一致
...
public class JavaBasicLearnMain {
	 ...
	 *
	 * 一个类里的方法不设置成static时 main方法 需要new出对象才能使用其中的方法
	 * 一个类里的方法 设置成static时 main方法 直接类名.方法名 即可调用
	 **/
	public static void main(String[] args) {
		// 32 求出 5位数中的所有 Lily Number
		LilyNumber.printLilyNumber();
...
//				"D:\\test", 10);
		...
		// ScannerTestMethods.scannerTest();
