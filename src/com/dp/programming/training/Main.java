package com.dp.programming.training;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Bc44() ;// 17 BC44 小乐乐与欧几里得 最大公约数和最小公倍数
		// Bc56();// 18 BC56 判断字母
		// Bc72(); // 19 BC72 日期比较
	...
	/*
	 * 19 BC72 判断字母 从键盘任意输入一个字符，编程判断是否是字母（包括大小写）。
	 */
	public static void Bc72() {
		...
		while (sc.hasNext()) {
			...
			LocalDate date1 = LocalDate.of(y1,m1,d1);//JDK1.8 以后可用  1.6没有
			LocalDate date2 = LocalDate.of(y2,m2,d2);

			int i = date1.compareTo(date2);
			if (i > 0){
				System.out.println("第一次输入的日期大于第二次输入的日期");
			}else{
				System.out.println("第二次输入的日期大于第一次输入的日期");
			}
		}
		sc.close();
	}
	/*
	 * 18 BC56 判断字母 从键盘任意输入一个字符，编程判断是否是字母（包括大小写）。
	 */
	public static void Bc56() {
		Scanner sc = new Scanner(System.in);
		while (sc.hasNext()) {
			String a = sc.next();
	...
	/*
	 * 17 BC44 小乐乐与欧几里得 最大公约数和最小公倍数
	 */
	public static void Bc44() {
		Scanner sc = new Scanner(System.in);
		while (sc.hasNext()) {
			int a = sc.nextInt();
			int b = sc.nextInt();
	...
	public static void calSphereVolume() {
		...
		while (sr.hasNext()) {
			...
			System.out.printf("%.3f",volume);//小数点后面保留3位,不够后面补0;
			System.out.println();
			System.out.printf("%2.3f",volume);//同上
